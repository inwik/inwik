...
function notifyMe() {
    var options = {
        title: "Notificación de inwik",
        body: "Hello world!",
        icon: '/app/templates/img/icons/icon.png'
    }
  ...
  // Let's check whether notification permissions have already been granted
    ...
    // If it's okay let's create a notification
      spawnNotification(options.title,options.body, options.icon);
  }
...
$(document).ready(function() {
	...
	function countNotifications(){
		...
		$.ajax({
			url: '/notifications?action=countNotifications',
			type: 'POST',
	...
	function newNotifications(){
		$.ajax({
			url: '/notifications?action=getNewNotifications',
			type: 'POST',
			dataType: "json",
	...
	function watchNotifications(){
		$.ajax({
			url: '/notifications?action=markAsWatched',
			type: 'POST',
    ...
    $("#notifications-header").click(function(){
		...
		$.ajax({
			data: parametros,
			url: '/notifications?action=markAsRead',
			type: 'POST',
			success:  function (response) {
				if (response == true){
